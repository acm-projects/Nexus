      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-6 items-center">
            <Link to="/courses" className="text-nexus-blue-900 hover:text-nexus-blue-500 flex items-center">
              <HiAcademicCap className="mr-1" /> Courses
            </Link>
            <Link to="/grade-calculator" className="text-nexus-blue-900 hover:text-nexus-blue-500 flex items-center">
              <HiCalculator className="mr-1" /> Grade Calculator
            </Link>
            <Link to="/chat" className="text-nexus-blue-900 hover:text-nexus-blue-500 flex items-center">

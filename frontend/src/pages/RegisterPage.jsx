      ...
      <motion.div className="min-h-screen flex items-center justify-center">
        {loading ? (
          <div className="flex items-center justify-center">
            <div className="spinner-border animate-spin inline-block w-8 h-8 border-4 rounded-full text-nexus-blue-600" role="status"></div>
            <span className="ml-2 text-nexus-blue-600">Loading courses...</span>
          </div>
        ) : (
